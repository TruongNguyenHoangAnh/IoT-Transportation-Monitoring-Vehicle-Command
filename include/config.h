...
#define FIREBASE_DATABASE_URL                                                  \
  "https://"                                                                   \
  "iot-transportation-monitoring-default-rtdb.asia-southeast1."                \
...
constexpr uint32_t NODE_STATUS_INTERVAL =
    10000; // Reduced from 60000ms to 10s for frequent status updates
